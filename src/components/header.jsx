...
const HeaderBtn = styled.button`
  ...
  align-items: center;
  color: ${(props) =>
    props.id === "write" ? (props.login_state ? "white" : "black") : "black"};
    ...
    return (
      <>
        <Head>
          ...
          <BtnList>
            <li>
              <Profile state={login} src={user.profileImg} alt="logo" />
            </li>
            ...
            <li>
              ...
              >
                <ImginBtn
                  src={!login ? register_icon : logout_icon}
                  alt="write"
                />
        ...
        <Modal modal_state={modalOn}>
          ...
          <Input ref={inputText} type="text" placeholder="E-mail Address" />
          <ModalLoginBtn type="button" onClick={handleLoginBtn}>
            Login
          </ModalLoginBtn>
